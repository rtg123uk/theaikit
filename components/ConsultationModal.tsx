...
export default function ConsultationModal({ isOpen, onClose }: ConsultationModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
      <div className="bg-white rounded-2xl w-full max-w-6xl h-[95vh] shadow-2xl relative flex flex-col overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          ...
          <div className="lg:w-1/3 bg-gradient-to-br from-purple-700 to-indigo-700 text-white p-6 flex flex-col justify-center">
          ...
          <div className="flex-1 p-6 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 min-h-0"> {/* Added min-h-0 to allow iframe to shrink */}
              <iframe
